...
namespace ClimbingPlaylistApi.Migrations
{
    ...
    [Migration("20230401211400_ManyToManyRouteToPlaylist")]
    partial class ManyToManyRouteToPlaylist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlaylistModelRouteModel", b =>
                {
                    b.Property<int>("PlaylistsContainingThisRouteId")
                        .HasColumnType("int");

                    b.Property<long>("RoutesId")
                        .HasColumnType("bigint");

                    b.HasKey("PlaylistsContainingThisRouteId", "RoutesId");
            ...
            modelBuilder.Entity("PlaylistModelRouteModel", b =>
                {
                    b.HasOne("ClimbingPlaylistApi.Models.PlaylistModel", null)
                        .WithMany()
                        .HasForeignKey("PlaylistsContainingThisRouteId")
